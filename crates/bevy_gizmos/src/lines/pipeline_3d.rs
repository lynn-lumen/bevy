use crate::{
    ...
    lines::{
        ...
        DrawLineJointGizmo, LineGizmo, LineGizmoUniformBindgroupLayout, SetLineGizmoBindGroup,
        LINE_JOINT_SHADER_HANDLE, LINE_SHADER_HANDLE,
    },
    GizmoRenderSystem,
};
...
impl SpecializedRenderPipeline for LineGizmoPipeline {
    ...
    fn specialize(&self, key: Self::Key) -> RenderPipelineDescriptor {
        ...
        RenderPipelineDescriptor {
            ...
            label: Some("line_gizmo_pipeline".into()),
...
impl SpecializedRenderPipeline for LineJointGizmoPipeline {
    ...
    fn specialize(&self, key: Self::Key) -> RenderPipelineDescriptor {
        ...
        RenderPipelineDescriptor {
            ...
            label: Some("line_joint_gizmo_pipeline".into()),
            push_constant_ranges: vec![],
        }
    }
}
